        ...
        private void ButtonNext_Click(object sender, EventArgs e)
        {
                ...
                if (TextBoxPassword.Text == TextBoxConfirmPassword.Text && CB_LowerCase.Checked == true && CB_UpperCase.Checked == true && CB_Number.Checked == true && CB_SpecialCharacter.Checked == true && CB_12Bits.Checked == true)
                {
                    ...
                    if (v != 1)
                    {
                        ...
                        command.Parameters.AddWithValue("@date", TextBoxBirthDate.Text);
                        command.Parameters.AddWithValue("@email", TextBoxEmail.Text);
                        command.Parameters.AddWithValue("@phonenumber", TextBoxPhoneNumber.Text);
                        command.Parameters.AddWithValue("@username", LabelDisplayUserName.Text);
                        command.Parameters.AddWithValue("@password", TextBoxConfirmPassword.Text);
