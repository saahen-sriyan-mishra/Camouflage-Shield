...
Button encrypt/save a form will appear to input an image choose a process for encryption and enter a key. your encrypted format for the Base64 form of the image will be shown. Save it or not depends.
...
(Algorithms used here are MD5, SHA-1, SHA-256, SHA-384 and SHA-512)
...
Limitation:
Do not use on high resolution image(high memory) or very complicated (colorful) image.  This application cannot handle more than 1mb (very high volume of data needs to be processed for this).
